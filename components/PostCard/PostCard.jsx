  ...
  return (
    <div className="w-[450px] mx-auto">
      ...
      <div>
        ...
        <p>
          <span className="font-medium">shariar17</span> Hi crush
        </p>
      </div>
      ...
      <div className="border-b">
        ...
        <div className="relative">
          <textarea
            ...
            rows="1.5"
            className="w-[90%] outline-none py-1  dark:bg-[#121212]"
            type="text"
            placeholder="Add a comment"
          />
          {comment && (
            <span className="absolute right-0 text-[#3797f0] font-bold hover:text-gray-700 cursor-pointer dark:hover:text-[white]">
              Post
            </span>
          )}
        </div>
